...
class CustomSignupForm(SignupForm):
    ...
    def clean_email(self):
        ...
        if '@' not in email or '.' not in email:
            raise forms.ValidationError('Формат email адреса некорректен, шаблон - username@domain.com')
    ...
    def clean_username(self):
        ...
        if username == email:
            raise forms.ValidationError('Имя пользователя и email адрес не должны совпадать')
    ...
    def clean(self):
        ...
        if password1 != password2:
            ...
            raise forms.ValidationError('Пароль должен состоять хотя бы из одной заглавной буквы')
